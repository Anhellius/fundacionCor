				...
				<div class="bar-content uk-position-relative">
					<ul class="uk-nav-default uk-nav-parent-icon" data-uk-nav>
						...
						<li class="uk-parent">
							<a href="#">Noticias</a>
							<ul class="uk-nav-sub">
								<li><a href="#">Crear nueva noticia</a></li>
								<li><a href="#">Listado de noticias</a></li>
							</ul>
						</li>
						<li class="uk-parent">
							<a href="#">Donaciones</a>
							<ul class="uk-nav-sub">
								<li><a href="#">Listado de donaciones</a></li>
							</ul>
						</li>
						<li class="uk-parent">
							<a href="#">Quienes somos</a>
							<ul class="uk-nav-sub">
								<li><a href="#">Misión, Objetivos, Actividades, Fundadores y consejo directivo</a></li>
							</ul>
						</li>
					...
					<div class="uk-width-1-1">
						...
						<div class="uk-card-header">
							<div class="uk-grid uk-grid-small">
								<div class="uk-width-auto"><h4 class="uk-margin-remove-bottom">Listado de Noticias</h4></div>
