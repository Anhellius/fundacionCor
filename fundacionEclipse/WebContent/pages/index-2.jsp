	...
	<body>
		<div class="uk-offcanvas-content">
			<div class="uk-position-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
				<img data-src="" width="" height="" alt="" uk-img src="" alt="demo-clip-css" class="element"> <!-- images/slide1.jpg -->
				...
				<div class="uk-container uk-container-expand">
					<nav class="uk-margin-top uk-margin-small-bottom" id="navbar" uk-navbar="mode: hover;">
						<div class="uk-navbar-left nav-overlay uk-visible@m">
							<a class="uk-navbar-item uk-logo" href="index.html" title="Logo"><img src="images/logo-2.jpeg" alt="Logo" style="height: 88px"></a>
							<ul class="uk-navbar-nav">
								...
								<li>
									<a href="#" title="Subscribe">Donaciones</a>
								</li>
								<li>
									<a href="#" title="Subscribe">Articulos</a>
								</li>
								<li>
									<a href="#" title="Subscribe">Contacto</a>
								</li>
							</ul>
						</div>
						...
						<div class="uk-navbar-right nav-overlay">
							...
							<div class="uk-navbar-item">
								<a class="uk-visible@s uk-margin-right" style="margin-right: 4px" href="#" uk-icon="facebook"></a>
								...
								<a href="login.html" class="uk-button uk-button-default">Login</a>
							</div>
...
<!-- 			<div class="uk-container uk-container-expand">
			...
			<!-- /NAVIGATION -->
			<!-- HERO -->
			<section class="uk-section uk-section-small"  uk-height-viewport="expand: true">
				<div class="uk-container uk-container-expand height-100vh">
					...
					<div class="uk-width-1-2@l  uk-text-center">
						<!-- <span style="letter-spacing: 0.2em;">BIENVENIDOS</span> -->
								<h1><span class="size-84">Fundación Cor</span></h1>
