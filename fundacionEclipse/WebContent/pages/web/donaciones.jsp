				...
				<div class="uk-container">
					<div class="uk-grid" uk-grid>
						<div class="uk-width-2-3@m uk-margin-medium-bottom">
							<h3 class="uk-heading-line uk-text-bold"><span>Formulario para donación mensual</span></h3>
	                        ...
	                        <stripes:form beanclass="cor.controlador.actionBeans.PanelActionBean" class="uk-grid-small uk-card-body" id="formularioDonacion" >
								...
								<div class="setup-content uk-width-1-1 uk-grid-small" id="step-1" uk-grid>
							        ...
							        <div class="uk-width-1-3@m form-group">
	                        			<input class="uk-input" type="text" placeholder="CUIT/CUIL" name="donacion.cuit" id="cuit" data-validation="number" data-validation-length="11-11" data-validation-error-msg='Ingrese un CUIT/CUIL válido'>
							        </div>
								...
								<div class="setup-content uk-width-1-1  uk-grid-small" id="step-2" uk-grid>
							        ...
							        <div class="uk-width-1-2@m">
	                        			<input class="uk-input" type="text" placeholder="Mail" name="donacion.email" id="email" data-validation="email" data-validation="required" data-validation-error-msg='Ingrese una cuenta de correo válida'>
							        </div>							        
							        <div class="uk-width-1-2@m">
	                        			<input class="uk-input" type="text" placeholder="Teléfono" name="donacion.telefono" id="telefono" data-validation="email" data-validation="number" data-validation-error-msg='Ingrese un  teléfono válida'>
							        </div>
								...
								<div class="setup-content uk-width-1-1  uk-grid-small" id="step-3" uk-grid>
							        ...
							        <div class="uk-width-2-5@m">
	                        			<input class="uk-input" type="text" placeholder="Dirección calle" name="donacion.calle" id="calle"  data-validation="required" data-validation-error-msg='Ingrese una  dirección válida'>
							        </div>
							        <div class="uk-width-1-5@m">
	                        			<input class="uk-input" type="text" placeholder="Nro" name="donacion.numero" id="calleNro"  data-validation="required"  data-validation-error-msg='Ingrese un  número válida'>
							        </div>
							        <div class="uk-width-1-5@m">
	                        			<input class="uk-input" type="text" placeholder="Piso" name="donacion.piso" id="callePiso"  data-validation="required" data-validation-error-msg='Ingrese un  piso válida'>
							        </div>
							        <div class="uk-width-1-5@m">
	                        			<input class="uk-input" type="text" placeholder="Dpto" name="donacion.depto" id="calleDpto"  data-validation="required" data-validation-error-msg='Ingrese un dpto válida'>
							        </div>
							        <div class="uk-width-1-3@m">
	                        			<input class="uk-input" type="text" placeholder="Provincia" name="donacion.provincia" id="provincia"  data-validation="required" data-validation-error-msg='Ingrese una provincia válida'>
							        </div>								        
							        <div class="uk-width-1-3@m">
	                        			<input class="uk-input" type="text" placeholder="Localidad" name="donacion.localidad" id="localidad"  data-validation="required" data-validation-error-msg='Ingrese una  localidad válida'>
							        </div>
							        <div class="uk-width-1-3@m">
	                        			<input class="uk-input" type="text" placeholder="Código Postal" name="donacion.cp" id="cp"  data-validation="required" data-validation-error-msg='Ingrese un CP válida'>
							        </div>
							        <div class="uk-wodth-1-1">
							        	<p class="uk-text-right  uk-margin-medium-top">
							        		<hr>
								...
								<div class="setup-content uk-width-1-1  uk-grid-small" id="step-4" uk-grid>
							        ...
							        <p>
							        	Autorizo a <span class="uk-text-primary">Fundación Cor</span>, entidad sin fines de lucro, a debitar a través del sistema de débito del banco <span class="uk-text-warning"><strong>Santander Rio</strong></span>, el siguiente aporte <strong>mensual</strong> de mi cuenta nro: <input class="uk-input uk-form-blank uk-form-width-medium" name="donacion.cuenta" type="text" placeholder="escriba el nro de cuenta"> del banco <input class="uk-input uk-form-blank uk-form-width-medium" type="text" placeholder="escriba el Banco" name="donacion.banco"> que se cancelará con solamente solicitarlo a mi banco.
							        </p>					        							        							      
							        <div class="uk-width-1-1">
							        	Faltan <span id="pres-max-length">24</span> números
							            <input class="uk-input" type="text" name="donacion.numeroCbu"  id="cbu" placeholder="CBU"  data-validation="number" data-validation-length="24-24"  data-validation-error-msg='Ingrese un CBU válida'>
							        </div>  							        
						...
						<div class="uk-width-1-3@m">
							<h3 class="uk-heading-line uk-text-bold"><span>Participación Empresarial</span></h3>
							<p>Tu empresa y vos pueden hacer mucho por la fundación COR y los chicos que viven en ella. Las Empresas que desean comprometerse con la niñez pueden ayudar mediante acciones de Responsabilidad Social.
							</p>
							<div class="uk-width-1-1@m">
								<a href="#" class="uk-button uk-button-default uk-button-large " type="button" uk-toggle="target: #mas-info">Más info</a>
							</div>
						...
						<div id="mas-info" uk-modal>
						    <div class="uk-modal-dialog uk-modal-body">
						        ...
						        <p>Existen muchas formas de sumarse a nuestra tarea, ya sea por donaciones, padrinazgos o a través de un aporte mensual.</p>

								<p>Las acciones dependerán de las posibilidades y objetivos de cada empresa, así como también de las múltiples formas que podamos idear juntos. En Fundación COR valoramos y necesitamos el aporte de todos. Por más pequeÃ±o que pueda resultar, a nosotros nos representa una importante ayuda, convirtiéndose en un pilar fundamental para que los niÃ±os puedan tener en futuro mejor.</p>

								<p>Si estás interesado en sumar tu colaboración, podemos brindarte asesoramiento en <strong>Responsabilidad Social Empresaria</strong>.</p>

								<p>Para mayor información, podés contactarnos a <a href="mailto:info@fundacióncor.org.ar">info@fundacióncor.org.ar</a> Tel./Fax 4793-8468</p>

								<p class="uk-text-lead">Todas las empresas que donan reciben el certificado oficial de donación.</p>

								<p>Las empresas donantes pueden obtener un <strong>beneficio impositivo</strong>, ya que la Fundación COR se encuentra inscripta como entidad beneficiaria, reconocida como exenta del Impuesto a las Ganancias. De esta manera, las donaciones realizadas a nuestra organización podrán deducirse de este impuesto, hasta el lÃ­mite del 5% de la renta neta del perÃ­odo fiscal correspondiente.</p>
						...
						<h4 class="uk-heading-line uk-text-bold"><span>Cuentas para donar por única vez</span></h4>
